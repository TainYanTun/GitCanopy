Here is the content formatted in clean, organized Markdown:
About the Challenge
...
Prize Tier Amount (Per Partner Bucket):
...
What to Submit
    ...
    Include a URL to your open-source code repository for judging and testing. The repository must be public and include a complete open source license file. This license should be detectable and visible at the top of the repository page (in the About section)
